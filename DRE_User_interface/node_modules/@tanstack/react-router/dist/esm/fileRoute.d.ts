...
type Replace<TValue extends string, TFrom extends string, TTo extends string> = TValue extends `${infer Start}${TFrom}${infer Rest}` ? `${Start}${TTo}${Replace<Rest, TFrom, TTo>}` : TValue;
